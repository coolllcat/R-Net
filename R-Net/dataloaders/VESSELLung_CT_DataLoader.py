...
VESSELLung_CT_LABEL_DICT = {
    'Lung': [1],
}


VESSELLung_CT_RGB_MAPPING_DICT = {
    'Lung': [230, 148, 34],
} 
...
class VESSELLung_CT_Dataset(Dataset): 
    def __init__(self, args, is_train: bool, transforms=None) -> None:
        ...
        if self.is_atlas: 
            ...
            print("VESSELLung CT data split: train: {}, valid and test: {}".format(num_train, num_valid_test)) 
            ...
            print("VESSELLung CT data split: train: {}, valid and test: {}".format(len(self.sample_pairs_train), len(self.sample_pairs_valid_test)))
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--root_dir', type=str, default='/data/postgraduate/wmw/UniRegDatasets/VESSEL_Lung_CT', help='root dir where stores data') 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(VESSELLung_CT_LABEL_DICT),   
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = VESSELLung_CT_Dataset(args, True, train_transforms) 
    valid_test_dataset = VESSELLung_CT_Dataset(args, False, valid_test_transforms) 
