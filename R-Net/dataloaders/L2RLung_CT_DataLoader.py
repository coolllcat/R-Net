...
L2RLung_CT_LABEL_DICT = {
    'Lung': [1],
}


L2RLung_CT_RGB_MAPPING_DICT = {
    'Lung': [230, 148, 34],
} 
...
class L2RLung_CT_Dataset(Dataset): 
    def __init__(self, args, is_train: bool, transforms=None) -> None:
        ...
        print("L2RLung CT data split: train: {}, valid and test: {}".format(len(self.train_sample_dirs), len(self.valid_test_sample_dirs))) 
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--root_dir', type=str, default='/data/postgraduate/wmw/UniRegDatasets/Learn2Reg_Lung_CT', help='root dir where stores data') 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(L2RLung_CT_LABEL_DICT),   
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = L2RLung_CT_Dataset(args, True, train_transforms) 
    valid_test_dataset = L2RLung_CT_Dataset(args, False, valid_test_transforms) 
