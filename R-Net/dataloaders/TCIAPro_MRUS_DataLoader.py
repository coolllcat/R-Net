...
TCIAPro_MRUS_LABEL_DICT = {
    "Prostate": [1], 
}


TCIAPro_MRUS_RGB_MAPPING_DICT = {
    "Prostate": [1], 
} 
...
class TCIAPro_MRUS_Dataset(Dataset): 
    def __init__(self, args, is_train: bool, transforms=None) -> None:
        ...
        print("TCIAPro MRUS data split: train: {}, valid and test: {}".format(len(self.train_sample_dirs), len(self.valid_test_sample_dirs))) 
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--root_dir', type=str, default='/data/postgraduate/wmw/UniRegDatasets/TCIA_Prostate_MRUS', help='root dir where stores data') 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(TCIAPro_MRUS_LABEL_DICT),   
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = TCIAPro_MRUS_Dataset(args, True, train_transforms) 
    valid_test_dataset = TCIAPro_MRUS_Dataset(args, False, valid_test_transforms) 
