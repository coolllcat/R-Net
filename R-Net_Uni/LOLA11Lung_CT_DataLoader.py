...
LOLA11Lung_CT_LABEL_DICT = {
    'Lung': [1],
}


LOLA11Lung_CT_RGB_MAPPING_DICT = {
    'Lung': [230, 148, 34],
} 
...
class LOLA11Lung_CT_Dataset(Dataset): 
    def __init__(self, args, is_train: bool, transforms=None) -> None:
        ...
        if self.is_atlas: 
            ...
            print("LOLA11Lung CT data split: train: {}, valid and test: {}".format(len(self.sample_pairs_train), len(self.sample_pairs_valid_test)))
...
if __name__ == "__main__": 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(LOLA11Lung_CT_LABEL_DICT),   
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = LOLA11Lung_CT_Dataset(args, True, train_transforms) 
    valid_test_dataset = LOLA11Lung_CT_Dataset(args, False, valid_test_transforms) 
