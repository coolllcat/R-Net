...
class ACDCHeart_MR_Dataset(Dataset): 
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--root_dir', type=str, default='/data/postgraduate/wmw/UniRegDatasets/ACDC_Heart_MR', help='root dir where stores data') 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(ACDCHeart_MR_LABEL_DICT),   
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = ACDCHeart_MR_Dataset(args, True, train_transforms) 
    valid_test_dataset = ACDCHeart_MR_Dataset(args, False, valid_test_transforms) 
