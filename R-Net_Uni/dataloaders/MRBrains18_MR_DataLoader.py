...
MRBrains18_MR_LABEL_DICT = {
    "Brain": [1, 2, 3, 5, 6], 
    "Cerebellum": [7],
    "Brain-stem": [8]
}

MRBrains18_MR_RGB_MAPPING_DICT = {
    "Cortical-Gray-Matter": [245, 245, 245], 
    "Basal-Ganglia": [205, 62, 78], 
    "White-Matter": [120, 18, 134],
    "Cerebrospinal-fluid": [196, 58, 250],
    "Ventricles": [220, 248, 164],
    "Cerebellum": [230, 148, 34],
    "Brain-stem": [122, 186, 220]
} 
...
class MRBrains18_MR_Dataset(Dataset): 
    def __init__(self, args, is_train: bool, transforms=None) -> None:
        ...
        if self.is_atlas: 
            ...
            print("MRBrains18 MR data split: train: {}, valid and test: {}".format(num_train, num_valid_test)) 
            ...
            print("MRBrains18 MR data split: train: {}, valid and test: {}".format(len(self.sample_pairs_train), len(self.sample_pairs_valid_test)))
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--root_dir', type=str, default='/data/postgraduate/wmw/UniRegDatasets/MRBrains18_Brain_MR', help='root dir where stores data') 
    ...
    train_transforms = RT.Compose([
        ...
        RT.RandomFlip(), 
        RT.Normalize(), 
        RT.AdjustChannels(MRBrains18_MR_LABEL_DICT),  
        RT.ToTensor() 
    ]) 
    ...
    train_dataset = MRBrains18_MR_Dataset(args, True, train_transforms) 
    valid_test_dataset = MRBrains18_MR_Dataset(args, False, valid_test_transforms) 
